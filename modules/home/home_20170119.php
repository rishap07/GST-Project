...
<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1000px; height: 372px; overflow: hidden; "> 
    ...
    <!-- Slides Container -->
    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 372px; overflow: hidden;"> 
...
<div class="mainwrapper">
    <div id="wrapper_main">
                        ...
                        <div class="moduletable_content">
                            <div class="announc">
                                <marquee onMouseOver="this.stop();" onMouseOut="this.start();" style="height: 233px;" direction="up" scrolldelay="500" height="233">
                                    <ul>
                                        <?php
                                        $dataAnnos = $db_obj->findAll(TAB_PREFIX . "announcement", "status='0' and is_deleted='0' and published_date<='" . date('Y-m-d') . "'", '', '', 'published_date desc');
                                        if (!empty($dataAnnos)) {
                                            foreach ($dataAnnos as $dataAnno) {
                                                if ($dataAnno->type == '0') {
                                                    ?>
                                                    <li><strong><?php echo $dataAnno->title; ?></strong></li>
                                                    <?php
                                                } else {
                                                    $url = '';
                                                    if ($dataAnno->type == '2') {
                                                    ...
                                                    ?>
                                                    <li><strong><a href="<?php echo $url; ?>" target="_blank"><?php echo $dataAnno->title; ?> </a></strong></li>
                                                    <?php
                                                }
                                                ?>
                                                <?php
                ...
                <div class="us_width-33">
                    <div class="moduletable">
                        <div class="moduletable_content">
                            ...
                            <div class="readmore" style="margin-top:20px;"><a href="?page=internal&itemid=5">read more</a></div>
                        </div>
                    </div>
                    <div class="moduletable">
      ...
      <div class="home_right" style="float:right; margin-right:20px; width:264px;"></div>
        ...
        <div style="width:769px; float:left; margin-bottom:1px; margin-left:24px; ">
