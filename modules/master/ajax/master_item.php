...
/* DB table to use */
$sTable = $obj_master->getTableName('item')."";
...
foreach($rResult as $aRow) {
    ...
    $row[] = utf8_decode($aRow->cess_tax_rate);
    $row[] = $status;
    $row[] = '<a href="'.PROJECT_URL.'/?page=master_item_update&id='.$aRow->item_id.'" class="iconedit hint--bottom" data-hint="Edit" ><i class="fa fa-pencil"></i></a>';
    $output['aaData'][] = $row;
    $temp_x++;
}
}
