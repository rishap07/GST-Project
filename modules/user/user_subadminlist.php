...
if( isset($_GET['action']) && $_GET['action'] == 'deleteSubadmin' && isset($_GET['id']) && $obj_user->validateId($_GET['id'])) {
...
<div class="admincontainer greybg">
    <div class="formcontainer">
        <div>
            <a class='addnew' href='<?php echo PROJECT_URL;?>/?page=user_subadminupdate'>Add New</a>
        </div>
        <h1>Admin User</h1>
        ...
        return {
            init: function () {
                ...
                $('#mainTable').dataTable({
                    ...
                    "bStateSave": false,
                    "bDestroy": true,
                    "sAjaxSource": "<?php echo PROJECT_URL; ?>/?ajax=user_subadminlist",
